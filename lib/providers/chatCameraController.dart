...
import 'package:nguoi_khuyet_tat/providers/deaf_detection/chat_deaf_detection_controller.dart';
import 'package:nguoi_khuyet_tat/providers/deaf_detection/deaf_detection_controller.dart';

final chatCameraController = Provider(
  ChatCameraController.new,
);

class ChatCameraController {
  ChatCameraController(this.ref);
  ...
  Future<void> startImageStream(int cameraIndex) async {
    await ref.read(chatDeafDetectionController.notifier).initializeController();
    ...
    await _cameraController!.startImageStream(
        ...
        _isProcessing = true;
        await ref.read(chatDeafDetectionController.notifier).detectDeaf(image);
