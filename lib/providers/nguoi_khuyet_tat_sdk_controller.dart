...
class NguoiKhuyetTatSdkController extends StateNotifier<List<YoloResult>> {
  NguoiKhuyetTatSdkController(this.ref) : super([]);
  ...
  Future<void> initialize() async {
    await nguoiKhuyetTatSDK.load(isBlind: null, isDeaf: null
